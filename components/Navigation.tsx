      ...
      <nav className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between relative" aria-label="Main Navigation">
        ...
        <div className="flex items-center gap-2 md:gap-4 relative z-20">
          ...
          <a
            ...
            title="Contact us"
          >
            <Mail size={18} fill="currentColor" className="fill-current">
              <path
          ...
          <button 
            ...
            className="hidden md:flex h-11 bg-[#105CB3] text-white px-6 rounded-full text-sm font-bold uppercase tracking-wider hover:bg-[#0c4a91] transition-colors items-center justify-center gap-2 leading-none focus:outline-none focus-visible:ring-4 focus-visible:ring-blue-300 cursor-pointer"
